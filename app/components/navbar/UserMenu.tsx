  ...
  return (
    <div className="relative">
      <div className="flex flex-row items-center gap-3">
        ...
        <div
          onClick={toggleOpen}
          className="p-4 md:py-1 md:px-2 border-[1px] border-neutral-200 flex flex-row items-center gap-3 rounded-full cursor-pointed hover:shadow-md transition"
        >
          <AiOutlineMenu />
            ...
            <div className="flex flex-col cursor-pointer">
              {currentUser ? (
                <>
                  ...
                  <MenuItem onClick={rentModal.onOpen} label="Add new listings" />
                  <hr />
